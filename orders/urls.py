...
from orders.views import get_cart_view, add_to_cart_view, remove_from_cart_view, clear_cart_view, CheckoutView, CheckoutSuccessView
...
urlpatterns = [
    ...
    path('checkout/success/<int:pk>/', CheckoutSuccessView.as_view(), name='checkout-success'),
]
